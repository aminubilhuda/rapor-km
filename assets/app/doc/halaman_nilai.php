...
<table width="780px" style="border-collapse: collapse;" >
	<tr>
		<td style="width: 100%; text-align: center;"><b><u>LAPORAN CAPAIAN AKADEMIK</u></b></td>
	</tr>
</table>
<br><br>
...
<table width="780px" style="border-collapse: collapse;" border="1" >
	...
	while ($rowmapelkelas = mysqli_fetch_array($mapelkelas)) {
		...
		$nilai = mysqli_fetch_array(mysqli_query($mysqli,"SELECT * FROM nilai_akhir WHERE id_mapel_kelas='$rowmapelkelas[id_mapel_kelas]' AND id_siswa='$siswa[id_siswa]' AND tahun='$lembaga[tahun]' AND semester='$lembaga[semester]'"));
	...
	<tr>
		...
		<td style="width: 50%; text-align: left; padding-left: 5px; padding-right: 5px; justify-content: center;">Mampu <?php echo $tujuan['tp'] ?> <br> Perlu Bimbingan dalam <?php echo $tujuanmin['tp'] ?></td>
	</tr>
	...
	<tr>
		...
		<td style="width: 10%; text-align: center;" >
			<b>
			<?php  
			$jumlahnilai = mysqli_fetch_array(mysqli_query($mysqli,"SELECT SUM(nilai) AS jumlahnilai FROM nilai_akhir WHERE id_siswa='$siswa[id_siswa]' AND tahun='$lembaga[tahun]' AND semester='$lembaga[semester]'"));
