...
<body>
		...
		<tr>
			<td style="width: 100%; padding-left: 5px; font-size: 16px; padding-top: 10px; padding-bottom: 10px;">
				<table width="790px" style="border-collapse: collapse; font-size: 11px;" >
					<tr>
						<td style="width: 80%; padding-left: 5px; font-size: 16px; padding-top: 5px; padding-bottom: 5px;"><b>SURAT AKTIFASI AKUN SEKOLAH</b><br>
	...
	<table width="790px" style="border-collapse: collapse; font-size: 11px;">
		<tr>
			<td style="font-size: 14px; width: 50%; padding-left: 25px;">Kepada Yth, <br>
				<b><?php echo $akunsekolah['kepala_sekolah'] ?></b> <br>
				di <?php echo $akunsekolah['nama_sekolah'] ?> <br>
				Kab. <?php echo $akunsekolah['kabupaten'] ?> - <?php echo $akunsekolah['provinsi'] ?>
			</td>
	...
	<table width="790px" style="border-collapse: collapse; font-size: 14px; ">
		<tr>
			<td style="width: 95%; padding-left: 25px; line-height: 20px;">
				Dengan hormat, <br><br>
				Sehubungan dengan permintaan saudara untuk melakukan Aktifasi Akun Sekolah anda dengan informasi sebagai berikut :
			</td>
		</tr>
	</table>
	<br><br><br>
	...
	<table width="790px" style="border-collapse: collapse; font-size: 14px;">
		<tr>
			<td style="width: 95%; padding-left: 25px; line-height: 20px;">
				Maka kami telah melakukan aktifasi sekolah anda. Untuk dapat menggunakan kembali layanan PENGGERAK, silahkan gunakan password sebagai berikut :
			</td>
		</tr>
	</table>
	<br><br>
